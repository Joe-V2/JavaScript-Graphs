...
Lynch, T. (2020) Zoomable Candlestick Chart. Javascript, CSS and HTML code example. Available online: https://bl.ocks.org/tompiler/6045b80d2164077faaf96e0304531bba [Accessed 1/06/2020]
Used under the MIT License.

A try-catch statement has been added to the constructor arguments for the xAxis object.
This is due to repeatable errors during debugging when out-of-bounds type errors were made manifest.

*/

function drawChart() {

	d3.csv("dowj.csv").then(function(prices) {
		...
		var xAxis = d3.axisBottom()
					    		...
					    		.tickFormat(function(d) {
									...
									{
										console.log("Exception reached: data undefined, skipping return statement")
									}
									});
